                    ...
                    <div class="product-details" style="min-height: 470px;"><!--product-details-->
                        ...
                        <div class="col-sm-6">
                            <div class="product-information"><!--/product-information-->
                                ...
                                <p><b>Loại SIZE Sẵn Còn:</b></p>
                                    <p class="btn btn-fefault cart addcart">S</p>                              
                                    <p class="btn btn-fefault cart addcart">L</p>                              
                                    <p class="btn btn-fefault cart addcart">XL</p>                              
                                    <p class="btn btn-fefault cart addcart">XXL</p>                              
                                </p>
                                <span>
