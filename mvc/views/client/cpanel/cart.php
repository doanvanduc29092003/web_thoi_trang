				...
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">
							...
							<td class="description">Chọn SIZE</td>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="total_area">
							...
							<button style="margin-left: unset;" name="submit" class="btn btn-default update">Thanh Toán Khi Nhận Hàng</button>
							<button style="margin-left: unset;" name="" class="btn btn-default update"><a href="<?= base ?>/thanh_toan_online/online.php" style="color: #fff;">Thanh Toán Online</a></button>
						</div>
					</div>
				</div>
			</div>
