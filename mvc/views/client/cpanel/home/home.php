				...
				<div class="col-sm-12">
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active" style="color: #ddd;">
								<div class="col-sm-6">
									<h1>N6 SHOP - xin chào quý khách</h1>
									<h2 style="color: #ddd;">Sản phẩm web nhóm 5</h2>
									<!-- <button type="button" class="btn btn-default get">Get it now</button> -->
								</div>
								<div class="col-sm-6">
									<img style="min-height: 400px; object-fit: cover;max-height: 400px;min-width: 390px;" src="public/images/img_banner/like1.png" class="girl img-responsive" alt="" />
								</div>
							</div>
        ...
        <div class="row">
            <div class="col-sm-3" id="mobi">
					<div class="left-sidebar">
                        ...
                        <!--Sản Phẩm Sale   -->
                        <h2 class="title text-center">Sản Phẩm Giảm Giá &darr;</h2>
                        <?php foreach($data["productsale"] as $key=>$values){?>
                        <div class="col-sm-12 category-products" style="border: 1px solid #ddd; border-radius: 5px;padding-top: 15px;">
                            <div class="product-image-wrapper"style="max-height: 400px;">
                                <div class="single-products"style="max-height: 400px;">
                                    <div class="productinfo text-center" style="max-height: 450px;">
                                        ...
                                        <span class="sale-badge" style="background-color: #FF0000;
                                                                        color: #FFFFFF;
                                                                        padding: 5px 10px;
                                                                        border-radius: 5px;
                                                                        position: absolute;
                                                                        top: 10px; 
                                                                        right: 10px;">SALE</span>
                                    </div>
            ...
            <div class="col-sm-9 padding-right">
                <!--features_items-->
                    ...
                    <!--phân trang-->
                    <div class="getpage" id="getpage" style="margin-bottom: 5px; margin-left: 350px;height: 30px;">
                            <!-- phân trang sản phẩm -->
                    </div>
                    <!--features_items-->
                                    ...
                                    <div class="product-image-wrapper" style="max-height: 400px; min-height: 400px;">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <p><?=$values["name"]?></p>
                                                <a href="javascript:void(0)" class="btn btn-default add-to-cart" idproduct = "<?=$values['id']?>"><i class="fa fa-shopping-cart"></i>Mua Hàng</a>
                                                <span class="new-badge" style="background-color: blue; 
                                                                               color: #FFFFFF; 
                                                                               padding: 5px 10px; 
                                                                               border-radius: 5px;
                                                                               position: absolute;
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <p><?=$values["name"]?></p>
                                                <a href="javascript:void(0)" class="btn btn-default add-to-cart" idproduct = "<?=$values["id"]?>"><i class="fa fa-shopping-cart"></i>Mua Hàng</a>
                                                <span class="hot-badge" style="background-color: blue; 
                                                                               color: #FFFFFF; 
                                                                               padding: 5px 10px; 
                                                                               border-radius: 5px;
                                                                               position: absolute;
                                                                               top: 10px;
                                                                               right: 10px;"><i class="fa fa-fire" style="color: #FF0000;"></i> HOT</span>
                                            </div>
